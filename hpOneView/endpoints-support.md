...
|<sub>/rest/backups/config</sub>                                                          |GET       | :white_check_mark:   | :white_check_mark:   |
|<sub>/rest/backups/config</sub>                                                          |PUT       | :white_check_mark:   | :white_check_mark:   |
|<sub>/rest/backups/remotearchive/{id}</sub>                                              |PUT       | :white_check_mark:   | :white_check_mark:   |
|<sub>/rest/backups/remotearchive/{id}</sub>                                              |DELETE    | :white_check_mark:   | :white_check_mark:   |
...
|<sub>/rest/restores</sub>                                                                | POST     | :white_check_mark:   | :white_check_mark:   |                      |
|<sub>/rest/restores/failures</sub>                                                       | POST     | :white_check_mark:   | :white_check_mark:   |                      |
|<sub>/rest/restores/{id}</sub>                                                           | POST     | :white_check_mark:   | :white_check_mark:   |                      |
|     **Roles**                                                                                                                                     |
