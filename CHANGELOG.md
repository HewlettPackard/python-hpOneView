...
- [#273](https://github.com/HewlettPackard/python-hpOneView/issues/273) and [#324](https://github.com/HewlettPackard/python-hpOneView/issues/324) Enabling authentication using sessionID
